...
const NEIGHBORHOODS = [
  ...
  { nom: 'Almadies', zone: 'dakar_centre' },
  { nom: 'Arafat', zone: 'dakar_centre' },
  { nom: 'Biscuiterie', zone: 'dakar_centre' },
  { nom: 'Cambérène', zone: 'dakar_centre' },
  { nom: 'Cité Keur Gorgui', zone: 'dakar_centre' },
  { nom: 'Cité Lobatt Fall', zone: 'dakar_centre' },
  { nom: 'Cité Millionnaire', zone: 'dakar_centre' },
  { nom: 'Dakar Plateau', zone: 'dakar_centre' },
  { nom: 'Fann Résidence', zone: 'dakar_centre' },
  { nom: 'Gueule Tapée', zone: 'dakar_centre' },
  { nom: 'Hann Bel Air', zone: 'dakar_centre' },
  { nom: 'Hann Maristes', zone: 'dakar_centre' },
  { nom: 'Madeleine', zone: 'dakar_centre' },
  { nom: 'Médina Gounass', zone: 'dakar_centre' },
  { nom: 'Nimzatt', zone: 'dakar_centre' },
  { nom: 'Ouest Foire', zone: 'dakar_centre' },
  { nom: 'Patte d\'Oie', zone: 'dakar_centre' },
  { nom: 'Rebeuss', zone: 'dakar_centre' },
  ...
  { nom: 'Centenaire', zone: 'dakar_centre' },
  { nom: 'Cité Avion', zone: 'dakar_centre' },
  { nom: 'Cité Damel', zone: 'dakar_centre' },
  { nom: 'Cité Djily Mbaye', zone: 'dakar_centre' },
  { nom: 'Cité Mixta', zone: 'dakar_centre' },
  { nom: 'Fan Hock', zone: 'dakar_centre' },
  { nom: 'Gibraltar', zone: 'dakar_centre' },
  { nom: 'Hock', zone: 'dakar_centre' },
  { nom: 'Jet d\'Eau', zone: 'dakar_centre' },
  { nom: 'Karack', zone: 'dakar_centre' },
  { nom: 'Le Virage', zone: 'dakar_centre' },
  { nom: 'Mamelles', zone: 'dakar_centre' },
  { nom: 'Niary Tally', zone: 'dakar_centre' },
  { nom: 'Petit Mbao', zone: 'dakar_centre' },
  { nom: 'Route de l\'Aéroport', zone: 'dakar_centre' },
  { nom: 'Tilène', zone: 'dakar_centre' },
  { nom: 'Zone de Captage', zone: 'dakar_centre' },
  { nom: 'Aïnoumady', zone: 'dakar_centre' },
  // Banlieue — 3 000 FCFA
  ...
  // Nouveaux quartiers Banlieue
  { nom: 'Dalifort Foirail', zone: 'dakar_banlieue' },
  { nom: 'Djiddah Thiaroye Kao', zone: 'dakar_banlieue' },
  { nom: 'Guinaw Rails Nord', zone: 'dakar_banlieue' },
  { nom: 'Guinaw Rails Sud', zone: 'dakar_banlieue' },
  { nom: 'Pikine Est', zone: 'dakar_banlieue' },
  { nom: 'Pikine Nord', zone: 'dakar_banlieue' },
  { nom: 'Pikine Ouest', zone: 'dakar_banlieue' },
  { nom: 'Pikine Sud', zone: 'dakar_banlieue' },
  { nom: 'Tivaouane Diacksao', zone: 'dakar_banlieue' },
  { nom: 'Golf Nord', zone: 'dakar_banlieue' },
  { nom: 'Hamo 4', zone: 'dakar_banlieue' },
  { nom: 'Hamo 5', zone: 'dakar_banlieue' },
  { nom: 'Hamo 6', zone: 'dakar_banlieue' },
  { nom: 'Hamo 7', zone: 'dakar_banlieue' },
  { nom: 'Ndiarème Limamoulaye', zone: 'dakar_banlieue' },
  { nom: 'Sam Notaire Extension', zone: 'dakar_banlieue' },
  { nom: 'Jaxaay', zone: 'dakar_banlieue' },
  { nom: 'Mbeubeuss', zone: 'dakar_banlieue' },
  { nom: 'Sangle', zone: 'dakar_banlieue' },
  { nom: 'Cité Aliou Sow', zone: 'dakar_banlieue' },
  { nom: 'Cité Biagui', zone: 'dakar_banlieue' },
  { nom: 'Cité Douane', zone: 'dakar_banlieue' },
  { nom: 'Cité Enseignants', zone: 'dakar_banlieue' },
  { nom: 'Cité Gadaye', zone: 'dakar_banlieue' },
  { nom: 'Gadaye', zone: 'dakar_banlieue' },
  { nom: 'Kounoune', zone: 'dakar_banlieue' },
  { nom: 'Lac Rose', zone: 'dakar_banlieue' },
  { nom: 'Niayes', zone: 'dakar_banlieue' },
  { nom: 'Nord Foire', zone: 'dakar_banlieue' },
  { nom: 'Sipres 1', zone: 'dakar_banlieue' },
  { nom: 'Sipres 2', zone: 'dakar_banlieue' },
  { nom: 'Sipres 3', zone: 'dakar_banlieue' },
  { nom: 'Sipres 4', zone: 'dakar_banlieue' },
  { nom: 'Wakhinane', zone: 'dakar_banlieue' },
  { nom: 'Keur Mbaye Fall', zone: 'dakar_banlieue' },
  { nom: 'Tivaoune Peul', zone: 'dakar_banlieue' },
  // Régions — 5 000 FCFA
  ...
  { nom: 'Sendou', zone: 'regions' },
  { nom: 'Bambilor', zone: 'regions' },
];
